...
class ChildGroupResponse {
  ...
  factory ChildGroupResponse.fromMap(Map<String, dynamic> map) {
    if (map == null) return null;

    return ChildGroupResponse(
      name: map['name'],
      description: map['description'],
      image: FileResponse.fromMap(map['image']),
      ...
      subCategories: map['subCategories'] != null
          ? List<GroupSubCategoryResponse>.from(map['subCategories']
              ?.map((x) => GroupSubCategoryResponse.fromMap(x)))
          : null,
      category: map['category'] != null
          ? GroupCategoryResponse.fromMap(map['category'])
          : null,
      ownerId: map['ownerId'],
      id: map['id'],
      isValid: map['isValid'],
  ...
  bool operator ==(Object o) {
    ...
    return o is ChildGroupResponse &&
        o.name == name &&
