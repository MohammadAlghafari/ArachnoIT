...
class RegisterIndividualUserScreen extends StatefulWidget {
  static const routeName = '/register_Individual_user_screen';
  final SocailRegisterParam socailRegisterParam;

  const RegisterIndividualUserScreen({Key key, this.socailRegisterParam}) : super(key: key);

  @override
  _RegisterIndividualUserScreenState createState() => _RegisterIndividualUserScreenState();
}

class _RegisterIndividualUserScreenState extends State<RegisterIndividualUserScreen> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBarProject.showAppBar(
            ...
            AppLocalizations
                .of(context)
                .register_as_a_health_care_provider,
            ...
            child: BlocListener<RegistrationBloc, RegistrationState>(
              listener: (context, state) {
                if (state is PasswordVisibilityChangedState) {
                  ...
                  showDialog(context: context, builder: (contexxt) => ActivationDialog());
                else if (state is RegistrationIsTouchPointNameEmailMobileAvailableState &&
                ...
                children: [
                  ...
                  RegistrationHeadline(
                      text: AppLocalizations.of(context).register_new_account +
                          "\"" +
                          AppLocalizations.of(context).individual_user +
                          "\""),
                  RegistrationCard(
                    ...
                    children: [
                      ...
                      RegisterCardSubHeadline(text: AppLocalizations.of(context).touch_point_name_),
                      SizedBox(
                        height: 5,
                      ),
                      BlocBuilder<RegistrationBloc, RegistrationState>(
                        ...
                        child: Align(
                            ...
                            child: Text(
                              AppLocalizations.of(context)
                                  .licence_to_practice_is_recommended_to_use,
                        ...
                        children: [
                          ...
                          Positioned(
                            child: RegisterCardSubHeadline(
                                text: AppLocalizations.of(context).date_of_birth_),
                          )
                        ],
                      ),
                      SizedBox(
                      ...
                      Stack(
                        children: [
                          BlocBuilder<RegistrationBloc, RegistrationState>(
                            ...
                            builder: (context, state) {
                              return DropDownTextField(
                                hintText: AppLocalizations.of(context).qualification,
                          ...
                          Positioned(
                            child: RegisterCardSubHeadline(
                                text: AppLocalizations.of(context).qualification_),
                          )
                        ],
                      ),
                      SizedBox(
