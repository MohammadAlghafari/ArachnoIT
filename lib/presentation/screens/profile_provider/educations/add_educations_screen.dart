...
//
class AddEducationsScreen extends StatefulWidget {
  @override
  _AddEducationsScreen createState() => new _AddEducationsScreen();
}

class _AddEducationsScreen extends State<AddEducationsScreen> {
      ...
      body: BlocProvider<ProfileProviderEducationBloc>(
        ...
        child: BlocListener<ProfileProviderEducationBloc, ProfileProviderEducationState>(
          listener: (contex, state) {
            ...
            } else if (state is SuccessAddNewEducations) {
