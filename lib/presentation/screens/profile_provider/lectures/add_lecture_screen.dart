...
class AddLectureScreen extends StatefulWidget {
  @override
  _AddLectureScreen createState() => new _AddLectureScreen();
}

class _AddLectureScreen extends State<AddLectureScreen> {
  List<ImageType> file = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarProject.showAppBar(title: AppLocalizations.of(context).add_new_lecture),
      body: BlocProvider<ProfileProviderLecturesBloc>(
        ...
        child: BlocListener<ProfileProviderLecturesBloc, ProfileProviderLecturesState>(
          listener: (contex, state) {
            ...
            } else if (state is SuccessAddNewLectures) {
              Navigator.of(context).pop();
              Navigator.of(context).pop();
            }
            if (state is RemoveItemFromFileListState) {
      ...
      children: [
        ...
        RaisedButton(
          ...
          onPressed: () {
            ...
            profileProviderLecturesBloc.add(AddNewLecturesState(
              file: file,
              context: context,
