...
class ReplyCommentItem extends StatefulWidget {
  ReplyCommentItem({Key key, @required this.comment}) : super(key: key);
  final CommentReplyResponse comment;
  @override
  _BlogReplyCommentItem createState() => _BlogReplyCommentItem();
}

class _BlogReplyCommentItem extends State<ReplyCommentItem> {
